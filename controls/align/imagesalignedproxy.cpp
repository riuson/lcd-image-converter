...
ImagesAlignedProxy::ImagesAlignedProxy(QObject *parent)
...
QVariant ImagesAlignedProxy::headerData(int section, Qt::Orientation orientation, int role) const
{
...
int ImagesAlignedProxy::columnCount(const QModelIndex &parent) const
{
...
QVariant ImagesAlignedProxy::data(const QModelIndex &index, int role) const
{
...
QModelIndex ImagesAlignedProxy::index(int row, int column, const QModelIndex &parent) const
{
  Q_UNUSED(parent)
  return this->createIndex(row, column);
}

QModelIndex ImagesAlignedProxy::parent(const QModelIndex &index) const
{
  Q_UNUSED(index)
  return QModelIndex();
}

QModelIndex ImagesAlignedProxy::mapFromSource(const QModelIndex &sourceIndex) const
{
  return this->index(sourceIndex.row(), sourceIndex.column(), sourceIndex.parent());
}

QModelIndex ImagesAlignedProxy::mapToSource(const QModelIndex &proxyIndex) const
{
...
void ImagesAlignedProxy::setCrop(int left, int top, int right, int bottom)
{
...
const QSize ImagesAlignedProxy::aligned(const QSize &value) const
{
  QSize result = value;
