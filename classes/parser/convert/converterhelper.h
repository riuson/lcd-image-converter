...
public:
  ...
  static void pixelsData(Settings::Presets::PrepareOptions* prepare, const QString& scanScript,
  ...
  // pack data
  static void packData(Settings::Presets::Preset* preset, QVector<quint32>* inputData, int inputWidth, int inputHeight,
                       QVector<quint32>* outputData);
  // bits reordering
  static void reorder(Settings::Presets::Preset* preset, QVector<quint32>* inputData, QVector<quint32>* outputData);

  static void compressData(Settings::Presets::Preset* preset, QVector<quint32>* inputData,
                           QVector<quint32>* outputData);
  ...
  static QString uint2string(Settings::Presets::DataNumeralSystem numeralSystem,
                             Settings::Presets::DataBlockSize blockSize, quint32 value);
  static QString dataToString(Settings::Presets::Preset* preset, QVector<quint32>* data);
  static QString previewDataToString(Settings::Presets::Preset* preset, const QVector<quint32>* data, int width,
                                     int height);
...
private:
  ...
  static void packDataRow(Settings::Presets::Preset* preset, QVector<quint32>* inputData, int start, int count,
                          QVector<quint32>* outputData, int* rowLength);
  static quint32 toBigEndian(Settings::Presets::Preset* preset, quint32 value);
  static void getImageDataSize(Settings::Presets::PrepareOptions* prepare, ConvImageScan* convImage, int* width,
                               int* height);
};
